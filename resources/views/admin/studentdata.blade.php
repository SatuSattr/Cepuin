...
<body class="antialiased">
    ...
    <div class="min-h-screen lg:flex">
        ...
        <div
            class="relative flex min-h-screen flex-1 flex-col bg-[var(--color-secondary)] lg:ml-30 lg:h-screen lg:overflow-y-auto w-full ">
            <div class="relative z-10 w-full px-4 py-8 sm:px-6 lg:px-8 ">
                <div class="mx-auto flex w-full  flex-col gap-8">
                    <section
                        ...
                        <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                            <div>
                                ...
                                <h1 class="mt-2 text-3xl font-semibold text-[var(--color-secondary)]">Data Interaksi
                                    Siswa</h1>
                                <p class="mt-3 max-w-2xl text-sm text-neutral-500">
                                    Lihat ringkasan siswa yang aktif melaporkan dan nama-nama yang paling sering
                                    dilaporkan. Gunakan data ini untuk memetakan kebutuhan pendampingan dan tindak
                                    lanjut konseling.
                                </p>
                            </div>
                            <div
                                class="inline-flex items-center gap-3 self-start rounded-3xl bg-gradient-to-br from-[var(--color-secondary)] to-[#470000] text-white shadow-[0_30px_60px_-45px_rgba(71,0,0,0.8)] px-4 py-3 ">
                                <span
                                    class="inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-[var(--color-secondary)]/10">
                                    <i class="fa-solid fa-chart-pie text-lg"></i>
                                </span>
                                <div class="pr-2">

                                    <p class="text-sm font-semibold text-white">Rekap laporan terbaru</p>
                                    <p class="text-xs text-white/70">Perbarui data secara berkala
                                        untuk analisis<br>yang akurat.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-10 grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
                            @foreach ($summaryCards as $card)
                                <article
                                    class="group relative overflow-hidden rounded-3xl border border-[var(--color-secondary)]/10 bg-white shadow-[0_30px_50px_-40px_rgba(128,1,1,0.55)] transition hover:-translate-y-1 hover:shadow-[0_40px_60px_-40px_rgba(128,1,1,0.6)]">
                                    <div
                                        class="absolute -right-6 -top-6 h-32 w-32 rounded-full bg-[var(--color-secondary)]/5 transition group-hover:scale-110">
                                    </div>
                                    <div class="relative p-6">
                                        <div class="flex items-center justify-between">
                                            <div
                                                class="rounded-2xl bg-[var(--color-secondary)]/10 p-3 text-[var(--color-secondary)]">
                                                <i class="{{ $card['icon'] }}"></i>
                                            </div>
                                            <span
                                                class="text-xs font-semibold uppercase tracking-wider text-[var(--color-secondary)]/50">Statistik</span>
                                        </div>
                    ...
                    <section
                        class="rounded-[40px] border border-white/60 bg-primary px-6 py-6 shadow-[0_40px_80px_-48px_rgba(128,1,1,0.55)] backdrop-blur sm:px-10 sm:py-12">
                        <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                            <div>
                                <h2 class="text-2xl font-semibold text-[var(--color-secondary)]">Relasi Pelapor &amp;
                                    Terlapor</h2>
                                <p class="mt-2 max-w-2xl text-sm text-neutral-500">
                                    Tinjau pasangan siswa yang terlibat dalam laporan. Setiap baris menunjukkan seberapa
                                    sering seorang pelapor melaporkan nama tertentu dan kapan terakhir kali laporan
                                    tersebut diterima.
                                </p>
                            </div>
                            <div
                                class="flex items-center gap-3 rounded-3xl border border-[var(--color-secondary)]/10 bg-[var(--color-secondary)]/5 px-4 py-3 text-sm text-[var(--color-secondary)]">
                        ...
                        <div class="mt-8 overflow-hidden rounded-3xl border border-neutral-100 shadow-sm">
                            @if ($reportPairs->isEmpty())
                                <div
                                    class="flex flex-col items-center justify-center gap-4 px-6 py-16 text-center text-neutral-500">
                                    <span
                                        class="inline-flex h-16 w-16 items-center justify-center rounded-full bg-[var(--color-secondary)]/10 text-[var(--color-secondary)]">
                                        <i class="fa-regular fa-face-smile-beam text-2xl"></i>
                                    </span>
                                    <div>
                                        <p class="text-sm font-semibold text-neutral-600">Belum ada data laporan</p>
                                        <p class="mt-1 text-xs text-neutral-500">Saat siswa mengirim laporan, ringkasan
                                            pasangan pelapor dan terlapor akan muncul di sini.</p>
                                    </div>
                                </div>
                            @else
                                    ...
                                    <table class="min-w-full divide-y divide-neutral-200 text-left text-sm">
                                        <thead class="bg-neutral-50 text-xs uppercase tracking-wider text-neutral-500">
                                            <tr>
                                                ...
                                                <th scope="col" class="px-6 py-4 font-semibold">Nama Dilaporkan
                                                </th>
                                                <th scope="col" class="px-6 py-4 font-semibold text-center">Jumlah
                                                    Laporan</th>
                                                <th scope="col" class="px-6 py-4 font-semibold text-right">Terakhir
                                                    Dilaporkan</th>
                                            </tr>
                                        </thead>
                                                ...
                                                <tr class="transition hover:bg-[var(--color-primary)]/40">
                                                    <td class="px-6 py-4">
                                                        <div class="flex items-center gap-3">
                                                            <span
                                                                class="inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-[var(--color-secondary)]/10 text-[var(--color-secondary)] font-semibold">
                                                    ...
                                                    <td class="px-6 py-4 text-center">
                                                        <span
                                                            class="inline-flex items-center justify-center rounded-full bg-[var(--color-secondary)]/10 px-4 py-1 text-sm font-semibold text-[var(--color-secondary)]">
